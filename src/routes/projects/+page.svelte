...
<svelte:head>
  ...
  <meta
    name="description"
    content="Explore my portfolio of projects across different categories including work experience, personal projects, academic work, freelance, and hackathons."
  />
  <meta
    name="keywords"
    content="projects, portfolio, software developer, computer science, full-stack, web development, personal projects"
  />
</svelte:head>
...
>
  ...
  <div class="md:!w-3/4 !w-full relative">
    ...
    <main
      ...
      style:height="{200 + projectsScrollerHeight}rem"
    >
      <section
        data-speed="clamp(0.09)"
        class="flex w-full flex-col items-center mt-4 mb-8 backdrop-blur-lg z-20 text-center"
      >
        <h1 class="text-5xl w-1/2 border-b-2 border-b-black">Projects</h1>
        <p class="text-sm mt-4">
          A collection of my work across different categories and domains
        </p>
      </section>
  ...
  <ResumeNav bind:mounted bind:smoother resumeSections={data.projectSections} class="nav-position" />

  <ResumeMobileNav bind:mounted bind:smoother resumeSections={data.projectSections} />
</div>
