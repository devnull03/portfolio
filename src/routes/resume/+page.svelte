...
<div
  class="bg-[url('/assets/resume-bg.png')] bg-black/20 h-full bg-blend-overlay bg-cover rounded-lg px-16 py-4 flex gap-6 font-courierPrime text-black"
>
  <div class="!w-3/4 relative">
    <div class="main-borders left-0">&nbsp;</div>
    <main id="smooth-content" class="px-6 *:px-4 flex flex-col gap-8 !h-[400rem]">
      <section
        data-speed="clamp(0.09)"
        class="w-full flex flex-col items-center mt-4 mb-8 backdrop-blur-lg z-20 text-center"
      >
        <h1 class="text-5xl w-1/2 border-b-2 border-b-black">
          Resume
        </h1>
                  ...
                  <div class="mb-3">
                    ...
                    <div class="flex flex-wrap gap-1">
                      {#each entry.technologies as tech}
                        <span class="bg-black/10 px-2 py-1 rounded text-sm font-courierPrime text-black">
                          {tech}
                        </span>
                      {/each}
                    </div>
              ...
              <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                {#each skills as skill}
                  <div class="skill-item">
                    <span class="bg-black/10 hover:bg-black/20 transition-colors duration-200 px-3 py-2 rounded-lg text-sm font-courierPrime text-black block text-center">
                      {skill.name}
